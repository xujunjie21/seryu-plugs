package ${package}.${shortName}.infrastructure.config;
...
@Slf4j
@Configuration
@MapperScan(basePackages = "${package}.${shortName}.infrastructure.repository.*",sqlSessionTemplateRef = "sqlSessionTemplate")
